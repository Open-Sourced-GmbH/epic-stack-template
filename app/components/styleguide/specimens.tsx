...
export const specimens: Specimen[] = [
...

	{
		name: 'sheet',
		group: 'Overlays',
		subtitle: 'slide-over panel — anchors to an edge (Sidebar mobile drawer)',
		viewport: { width: 560, height: 360 },
		// Rendered contained: the overlay/content are positioned `absolute` within
		// this `relative` box (and modal={false}) so the static specimen shows the
		// slide-over surface in place, without a full-screen portal that would lock
		// and dim the whole styleguide page.
		render: () => (
				...
				<Sheet open modal={false}>
					...
					<SheetContent side="left" className="absolute w-64">
						...
						<nav className="mt-4 flex flex-col gap-1 text-body-sm">
							<a
								className="text-foreground rounded-md px-2 py-1.5"
								href="#general"
							>
								General
							</a>
